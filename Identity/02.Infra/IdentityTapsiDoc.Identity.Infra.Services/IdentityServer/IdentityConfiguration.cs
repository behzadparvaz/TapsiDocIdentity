...
namespace IdentityTapsiDoc.Identity.Infra.Services.IdentityServer;
...
public sealed class IdentityConfiguration
{
    ...
    public static IEnumerable<ApiResource> GetApiResources()
    {
        return new List<ApiResource>
        {
            ...
            new ApiResource()
            {
                ...
                Description = "IT API",
                ApiSecrets = [new Secret("8A027752-C0BA-4979-A8B7-93236E3AC66D".Sha256())],
                Scopes = ["scope_identity"],
    ...
    public static IEnumerable<Client> GetClients()
    {
        ...
        return new[]
        {
            ...
            new Client()
            {
                AllowedGrantTypes = CustomGrantTypes.SecurityStampCredentials,
